...
public class CannonTower : CombatTowerBase
{
    ...
    protected override void ApplyLevelStats()
    {
        ...
        {
            case 1:
                minDamage = 9; maxDamage = 14; attackInterval = 2.0f; range = 3.5f;
                break;
            case 2:
                minDamage = 15; maxDamage = 24; attackInterval = 1.8f; range = 3.5f; stunDuration = 0.3f;
                break;
            case 3:
                minDamage = 22; maxDamage = 32; attackInterval = 1.7f; range = 3.5f; splashRadius = 1.2f; stunDuration = 0.5f;
                break;
            case 4:
                minDamage = 30; maxDamage = 42; attackInterval = 1.6f; range = 3.5f; splashRadius = 1.3f;
                groundZoneRadius = 1.1f; groundZoneDuration = 2f; groundZoneDps = 6f;
                break;
            case 5 when branch == TowerBranch.BranchA:
                minDamage = 38; maxDamage = 52; attackInterval = 1.5f; range = 3.5f; splashRadius = 1.4f;
